...
public class TCB
{
    ...
    /**
     * We capture all'outgoing packages and we take the following information
     * @param ipAndPort
     * @param mySequenceNum   generated number ()
     * @param theirSequenceNum tcpHeader.sequenceNumber
     * @param myAcknowledgementNum  tcpHeader.sequenceNumber + 1
     * @param theirAcknowledgementNum tcpHeader.acknowledgementNumber
     * @param channel
